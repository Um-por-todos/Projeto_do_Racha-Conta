...
* The original package name '.br.edu.iff.ccc.Um por todos' is invalid and this project uses 'br.edu.iff.ccc.Um.por.todos' instead.
...
```
$ docker run --rm -p 8080:8080 Um-por-todos:0.0.1-SNAPSHOT
```
